...
def SEC_fit(trial, plot=False):
    ...
    n_sec_lat, n_sec_lon = trial.suggest_int("n_sec_lat", 5, 20), trial.suggest_int("n_sec_lon", 20, 40)  # Number of rows and columns respectively of SECSs that will exist in the grid
